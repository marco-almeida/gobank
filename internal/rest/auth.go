...
import (
	...
	s "github.com/marco-almeida/gobank/internal/postgres"
	"github.com/sirupsen/logrus"
)

func JWTMiddleware(log *logrus.Logger, userRepository s.User, handlerFunc http.HandlerFunc) http.HandlerFunc {
